...
Measured from `build/gbc/gbc-rog.map` / `.noi` (**re-measured 2026-07-25**, after the '?' encounter
...
`enc_template`, `enc_region`, `enc_return_x/y`, `zone_stat_scale`) and that was the whole design
