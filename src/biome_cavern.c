...
static const EnemyDef defs[] = {
    /* ENEMY_BAT   */ { TILE_BAT_1,      TILE_BAT_2,        4, 3, PAL_ENEMY_BAT,   MOVE_BLINK,  3 }, // J2/K2 — blink up to 3 squares
    /* ENEMY_SNAKE */ { TILE_SNAKE_1,    TILE_SNAKE_2,      8, 3, PAL_ENEMY_SNAKE, MOVE_CHASE,  0 }, // J5/K5
    /* ENEMY_RAT   */ { TILE_RAT_OFF,    TILE_RAT_OFF,      4, 3, PAL_ENEMY_RAT,   MOVE_WANDER, 0 }, // J16 flip-anim
    /* ENEMY_SLIME */ { TILE_SLIME_1_OFF, TILE_SLIME_2_OFF, 4, 3, PAL_ENEMY_SNAKE, MOVE_CHASE,  0 }, // J11/K11
};
