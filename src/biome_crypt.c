...
// Crypt roster — undead-leaning subset.
static const EnemyDef defs[] = {
    ...
    /* ENEMY_SKEL_ARCHER */ { TILE_SKEL_1_OFF, TILE_SKEL_2_OFF, 2, 2, 0,                  MOVE_ARCHER, 5 }, // small skel + bow overlay; OCP0; range=5
};
