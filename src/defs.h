...
#define BELT_SLOT_COUNT   2u             // spell quick slots (left half of belt row) — loadout picked on the SPELL subscreen
...
#define AUTO_SCROLL_SPEED 6 // px/frame while auto-exploring — 2-frame glide (1 intermediate scroll frame, less jarring than an 8px hop); camera.c gates on auto_explore_active
...
#define TOWN_SHOP_SLOTS  8u
#define TOKENS_MAX      99u /* keeps the "*N" counter two digits wide */
