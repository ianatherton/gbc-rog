...
// the stack headroom is load-bearing (442 B as of 2026-07-27 — enemy_hidden[] tipped it over once;
// class_emblem_draw's ~320 B scale buffers now overlay floor_bits[] instead of the stack).
typedef struct {
