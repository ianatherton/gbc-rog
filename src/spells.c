...
static const SpellDef spell_defs[SPELL_ID_SPAN] = {
    ...
    {TILE_WITCH_BOLT_VRAM, PAL_WALL_BG, 1u, SPELL_RANK_MAX, 6u, 1u,
     "Smite", "Ranged stun bolt"},
    {TILE_KNIGHT_SHIELD_VRAM, PAL_WALL_BG, 1u, SPELL_RANK_MAX, 7u, 1u,
     "Shield Toss", "Bounce all foes"},
    ...
    {TILE_FOX_J9_VRAM, PAL_XP_UI_BG, 1u, SPELL_RANK_MAX, 10u, 1u,
     "Toad Plague", "Summon toad pets"},
    {TILE_ROOT_ICON_VRAM, PAL_XP_UI_BG, 1u, SPELL_RANK_MAX, 8u, 1u,
     "Poison Wall", "Poison cloud burst"},
    {TILE_FOX_J9_VRAM, PAL_WALL_BG, 1u, SPELL_RANK_MAX, 5u, 1u,
